...
// Neste caso acende o LED apos 0.5s
...
// Apaga o LED apos 1s do inicio do contador
...
int main(void){
    ...
    // Para este periodo, precisamos de 1s/16us = 62500 contagens do contador para ter aproximadamente 1s. 
  	...
  	OCR1A = 31250; // Momemento erm que o contador atinge 0.5s - Liga o bit
  	OCR1B = 62500; // Atingiu 1s - desliga o bit - reseta contador
